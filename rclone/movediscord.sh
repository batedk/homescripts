...
# credit to @XantherBanter
#
# Crontab -e: 12 3 * * * /home/bate/rclone/move-discord.sh >/dev/null 2>&1
# -----------------------------------------------------------------------------

SOURCE_DIR="/home/bate/rclone/cache/"
DESTINATION_DIR="gdrive:Media"

DISCORD_WEBHOOK_URL=""
DISCORD_ICON_OVERRIDE="https://i.imgur.com/MZYwA1I.png"
DISCORD_NAME_OVERRIDE="RCLONE"

LOCK_FILE="/home/bate/rclone/log/rclone-upload.lock"
LOG_FILE="/home/bate/rclone/log//rclone-upload.log"
